 ...
 * @remark
 *
 * 1.This interface can snap a video image, format now only support NV12, YUYV422, NV21, HSV and RGBA resolution support the same size of framesource resolution.
 *
