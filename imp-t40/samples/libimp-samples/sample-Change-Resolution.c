...
/*
 * The purpose of this sample is to switch the output stream from 1080p+720p to 720p+360p, and then switch to 360p+320x240
 * Both the main and second streams use the method of destroying encoders and framesources and recreating them to switch resolutions
 */
