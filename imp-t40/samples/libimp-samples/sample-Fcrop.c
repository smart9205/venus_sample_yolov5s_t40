...
/*
 * The main purpose of this sample is to implement the electronic zoom function using Fcrop
 * Currently due to encoding resolution limitations. As a result, it can only be magnified about 10 times at present
 */
...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i <= 6; i++) {
        ...
        chn[0].fs_chn_attr.fcrop.width = ((int)(((1920/zoom_test[i]))+15) & ~15);
        chn[0].fs_chn_attr.fcrop.height = ((int)(1080/zoom_test[i]))&(-1);
        chn[0].fs_chn_attr.scaler.enable = 0;
        chn[0].fs_chn_attr.picWidth = ((int)(((1920/zoom_test[i])) +15) & ~15);
